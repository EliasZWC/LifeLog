...
(function (global) {
    ...
    var MESSAGES = {
        en: {
            ...
            'update.failed.permission': 'Allow LifeLog to install apps in the system settings, then come back and retry.',
            ...
            'update.stalled': 'The previous install did not take effect. Allow LifeLog to install apps in the system settings, then try again.',
        ...
        zh: {
            ...
            'update.failed.permission': '请在系统设置里允许 LifeLog 安装应用，然后回到这里重试。',
            ...
            'update.stalled': '上一次安装没有生效。请确认系统已允许 LifeLog 安装应用，然后重试。',
