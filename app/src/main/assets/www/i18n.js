...
(function (global) {
    ...
    var MESSAGES = {
        en: {
            ...
            'metric.form.items.invalid': 'Give every item a name',
            ...
            'setting.timezone.system': 'Follow system',
            'setting.weekStart': 'Week starts on',
            ...
            'toast.importReason.empty': 'file is empty',
            'toast.importReason.header': 'not a Livolog CSV (missing metric/time columns)',
            'toast.importReason.format': 'not a Livolog CSV (missing metric/time columns)',
            'toast.importReason.norows': 'no readable rows — existing data kept',
            'toast.importReason.read': 'file could not be read',
        ...
        zh: {
            ...
            'setting.contact': '联系',
            'setting.timezone': '时区',
            'setting.timezone.system': '跟随系统',
            'setting.weekStart': '每周起始日',
            'setting.import': '导入数据',
            'setting.export': '导出数据',
